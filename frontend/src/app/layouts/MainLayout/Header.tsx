    ...
    return (<>
        <div className="flex items-center justify-between gap-4 px-4 py-2">
            <div className="flex items-center gap-x-4">
                <button type="button" className="cursor-pointer hover:bg-gray-300 hover:rounded-full p-2" >
                <Menu />
                </button>
            ...
            <div className="flex items-center gap-6 px-4">
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-300 rounded-full cursor-pointer">
                    <PlusIcon />
                    Create
                </div>
                <div>
